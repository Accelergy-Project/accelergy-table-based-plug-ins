...
def generate_data_files():
    ...
    for root, directories, file_names in os.walk(sets_of_tables_path):
        for file_name in file_names:
            ...
            if relative_root not in all_identifier_files:
                all_identifier_files[relative_root] = [relative_root + os.sep + file_name]
            else:
                all_identifier_files[relative_root].append(relative_root + os.sep + file_name)


    data_files = []
    share_root = 'share/accelergy/estimation_plug_ins/accelergy_table_plug_ins/'
    for relative_root, list_of_files in all_identifier_files.items():
